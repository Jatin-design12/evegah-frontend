...
import { EDIT, FAQ, MAINTENANCE, Publish, PublishEnumId, REPLY, ReOrder, ReplyCommentsStatus, UnublishEnumId, fe_action_add, fe_request_from_admin } from 'src/app/core/constants/common-constant';
...
export class FaqComponent implements OnInit {
  ...
  getListBySubmit(){
    ...
    let obj:any=
     {
      ...
      "faqPublishStatusEnumId":this.faqForm.value.EnumId
   }
    ...
    if (this.editData.action === 'edit') {
      ...
      obj.questionId = this.editData.data.questionId
      obj.add = 'update';
      }
  ...
  onActionHandler(event){
    ...
    this.buttonLabel= "Edit"
      this.faqForm.controls['question'].setValue((event.data.question));
